function vestibularLaunch(duration, path, handles, speed, gain, proto_name)
    ...
    params.moment_threshold = 1.5; % moment threshold for triggering an action
...
%     params.reinitializing = 0.5; % if fish does not move, reinintialize after this time [minutes]
    ...
    if isequal(proto_name, 'baseline')
        ...
        obj = vestibularMove(params, handles);
    end
