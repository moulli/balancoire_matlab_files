...
switch run
    case 1
        % Case first run:
        protocol = {
                    'baseline', 0.75, 'speed', 0, 'gain', 0, 'initial_angle', 0;
                    'vestibular', 0.75, 'speed', -4, 'gain', +1, 'initial_angle', 0;
                    'vestibular', 0.75, 'speed', -4, 'gain', +1.25, 'initial_angle', 0;
                    'vestibular', 0.75, 'speed', -4, 'gain', +0.75, 'initial_angle', 0;
                    };
    otherwise
        % Case not first run:    
        protocol = {
